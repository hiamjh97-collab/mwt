                                     ...
                                     <div className="flex gap-2">
                                         {['1:1', '16:9', '9:16', '4:3', '3:4'].map(r => (
                                             <button 
                                                 ...
                                                 className={`px-3 py-1.5 rounded-lg text-xs font-bold border ${aspectRatio === r ? 'bg-blue-600 text-white border-blue-600' : 'bg-transparent text-slate-500 border-slate-200 dark:border-slate-700'}`}
                                             >{r}</button>
                                         ))}
                                     </div>
                                 </div>
